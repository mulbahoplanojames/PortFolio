...
import countries from "../../data/globe.json"; // Adjust the path to your file

// Extend ThreeGlobe so it can be used in the JSX
...
export const Globe: React.FC<WorldProps> = ({ globeConfig, data }) => {
